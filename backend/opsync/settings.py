...
MIDDLEWARE = [
    ...
    "opsync.middleware.ContentSecurityPolicyMiddleware",
]

ROOT_URLCONF = "opsync.urls"
...
WSGI_APPLICATION = "opsync.wsgi.application"
ASGI_APPLICATION = "opsync.asgi.application"
